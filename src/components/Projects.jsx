    ...
    import { SiReact, SiMongodb, SiPython, SiGo } from 'react-icons/si';
                ...
                {projects.map((project, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-xl sm:text-3xl project-icon">{project.icon}</span>
                      <h3 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-white project-title">{project.name}</h3>
                    </div>
                    ...
                    {project.link && (
                      <a
                        ...
                        className="mt-auto flex items-center gap-2 text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 transition-colors project-link"
                      >
                        <FaExternalLinkAlt />
