            ...
            <div className="relative z-10 p-4 sm:p-8">
              ...
              <div className="flex flex-col gap-4 sm:gap-6">
                {certifications.map((cert, index) => (
                  <motion.div
                    key={index}
                    className="cert-card bg-white/20 dark:bg-white/10 p-4 sm:p-6 rounded-xl border border-white/40 shadow-lg backdrop-blur-lg"
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-xl sm:text-2xl cert-icon">{cert.icon}</span>
                      <div>
                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-white cert-title">{cert.name}</h3>
